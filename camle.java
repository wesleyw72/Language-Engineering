...
class camle {
  public static void main(String[] args)
  {
    ...
    outNonOp = outFile+"nonOptomised.ass";
    outFile = outFile+".ass";
    ...
    try {
      ...
      PrintStream o = new PrintStream(new FileOutputStream(outNonOp));
      Cg.program(newIrt, o);
      AssemFlowGraph afg = new AssemFlowGraph(outNonOp);
      Liveness lg = new Liveness(afg);
      Replacer replace1 = new Replacer(outNonOp,outFile);
      replace1.replaceRegisters(lg);
